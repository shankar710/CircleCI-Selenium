...
public class ZohoTest {
	...
	public static void zohocall() throws IOException{
		...
		property2 = new PropertyUtils("./ObjectRepository/EnvironmentVariable.properties");
...
//		
//	WebElement addemail = driver.findElement(By.xpath("//a[text()='LOGIN']"));

//		property2 = new myzohologin("./objectrepository/zohoproperty.properties");
//		property2.callzohourl("clicksettings");
//		String clicksettings1 = property2.callzohourl("clicksettings");
//		driver.
//		
//		
//	}
...
//			String s1 = property2.callzohourl("set");
//			WebElement settings = driver.findElement(By.xpath("s1"));
//			settings.click();
		...
		WebElement settings = driver.findElement(By.xpath("//span[contains(text(),'Settings')]"));
			...
			WebElement depart = driver.findElement(By.xpath("//a[text()='Department(s)']"));
			depart.click();
			Thread.sleep(1000);
			InfoStatus(LogStatus.INFO, "Navigated to Department");

			WebElement portal = driver.findElement(By.xpath("//a[text()='Portal Settings']"));
			portal.click();
			Thread.sleep(1000);
			InfoStatus(LogStatus.INFO, "Navigated to Portal Settings");

			WebElement blockedip = driver.findElement(By.xpath("//a[text()='Blocked IPs']"));
			blockedip.click();
			InfoStatus(LogStatus.INFO, "Navigated to Blocked IPs");

			WebElement websites = driver.findElement(By.xpath("//a[text()='Websites']"));
			websites.click();
			InfoStatus(LogStatus.INFO, "Navigated to Websites");

			WebElement auto = driver.findElement(By.xpath("//a[text()='Automation']"));
			auto.click();
			InfoStatus(LogStatus.INFO, "Navigated to Automation");


			WebElement temp = driver.findElement(By.xpath("//a[text()='Templates']"));
			temp.click();
			InfoStatus(LogStatus.INFO, "Navigated to Templates");


			WebElement lead = driver.findElement(By.xpath("//a[text()='Lead Scoring']"));
			lead.click();
			InfoStatus(LogStatus.INFO, "Navigated to Lead Scoring");


			WebElement inte = driver.findElement(By.xpath("//a[text()='Integrations']"));
			inte.click();
			Thread.sleep(2000);
			InfoStatus(LogStatus.INFO, "Navigated to Integrations");

		
		attachPOC("SettingsPage", LogStatus.PASS, "Navigated to settings successfully");
		oReport.endTest(ologger);
	}
		...
		public static void addoperator() throws IOException, InterruptedException {
			...
			WebElement email = driver.findElement(By.xpath("//input[@type='text'][@placeholder='Enter the email address']"));
			...
			Thread.sleep(3000);
			attachPOC("AddOperator", LogStatus.PASS, "Operator id added successfully");
			oReport.endTest(ologger);
		...
		public static void deloperator() {
			...
			WebElement delete1 = driver.findElement(By.xpath("//em[text()='Delete']"));
			delete1.click();
	    ...
	    public static void addtriger(String rulenames) throws IOException, InterruptedException{
	    	...
	    	aut.click();
	    	boolean btstatus=owrap.Iselementdisplayed(By.xpath("//*[@documentclick='addTriggers']"));
	    	System.out.println(btstatus);
	    	if (btstatus) {
	    		System.out.println("First rule is to be added");
	    		WebElement addnew=driver.findElement(By.xpath("//*[@documentclick='addTriggers']"));
	    		addnew.click();
			} else {
...
//				addnew2.click();
//			}
			InfoStatus(LogStatus.INFO, "Add rule page is displayed for rule id:"+rulenames);

	    	
	    	WebElement rulename=driver.findElement(By.xpath("//*[@data-type='ruletitle']"));
	    	rulename.sendKeys(rulenames);
	    	
	    	
	    	WebElement drop1=driver.findElement(By.id("triggerevent_0_div"));
	    	drop1.click();
	    	WebElement drop1V=driver.findElement(By.xpath("//*[@id='triggerevent_00']/li[@val='1']"));
	    	drop1V.click();
	    	
	    	WebElement drop2=driver.findElement(By.id("prior0_col1_div"));
	    	drop2.click();
	    	driver.findElement(By.className("asign-srctxbx")).sendKeys("visitor source");
	    	
	    	WebElement drop2V=driver.findElement(By.xpath("//li[@title='Visitor Source']"));
	    	drop2V.click();
	    	...
	    	driver.findElement(By.xpath("//*[@id='col3_div']/ul/li[@val='2']")).click();
	        ...
	        drop3.click();
	    	WebElement drop3v=driver.findElement(By.xpath("//*[@id='action_01']/li[@val='8']"));
	    	drop3v.click();
	    	WebElement drop3v2=driver.findElement(By.xpath("//*[@triggertype='8']"));
	    	drop3v2.click();
	    	drop3v2.sendKeys("20");
			InfoStatus(LogStatus.INFO, "All the details is filled for rule id :"+rulenames);

	    	
	    	WebElement save=driver.findElement(By.xpath("//*[@documentclick='handleRuleUpdate']"));
	    	save.click();
	    	Thread.sleep(2000);
//	    	ITestContext testContext = null;//	    	int count=testContext.getAllTestMethods()[0].getInvocationCount();
	    	attachPOC("AddTrigger"+rulenames, LogStatus.PASS, "TriggerRule added successfully for rule id :"+rulenames);
	   ...
	   // @Test(dependsOnMethods="addtriger")
  public static void verifyRule(String name) throws IOException{
	    	...
	    	WebElement ele=driver.findElement(By.xpath("//*[@id='rulelist']/div[1]//*[@class='w24p rule_dtl']/div[1]"));	    	
	    	String rslt=ele.getAttribute("innerText");
	    	System.out.println(rslt);

	    	WebElement ele2=driver.findElement(By.xpath("//*[@id='rulelist']/div[1]//*[@class='w24p rule_dtl']"));
			...
			WebDriverWait owait = new WebDriverWait(driver, 10);
			owait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath("//*[@id='rulelist']/div[1]//*[@class='w24p rule_dtl']/div"), 2));
			check2=driver.findElements(By.xpath("//*[@id='rulelist']/div[1]//*[@class='w24p rule_dtl']/div"));
	    	...
	    	for(int i=0; i<check2.size(); i++){
	    		...
	    		if(i==0){
	    			try {
						...
						// TODO: handle exception
						attachPOChild("RULE not added"+name, LogStatus.FAIL, "Exception is"+e);

					}
	    			
	    		}
	    		if(i==1){
	    			Assert.assertEquals(test.contains("Glow button after")&&test.contains("20"), true, "Trigger type is validated");
	    		}
	    		if(i==2){
	        ...
	        //oReport.endTest(Child);
	    }
  
     public static void attachPOC(String POCname,LogStatus status ,String msg) throws IOException{
	  String path=owrap.screenshot(POCname);
		System.out.println(path);
		String htmlTag = ologger.addScreenCapture(path);
		ologger.log(status, msg+htmlTag);			
  }
     public static void attachPOChild(String POCname,LogStatus status ,String msg) throws IOException{
   	  String path=owrap.screenshot(POCname);
   		System.out.println(path);
   		String htmlTag = Child.addScreenCapture(path);
   		Child.log(status, msg+htmlTag);			
     }
     public static void InfoStatus(LogStatus status ,String msg) throws IOException{
